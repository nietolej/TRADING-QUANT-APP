...
def render_ml_page():
    with ui.column().classes('w-full q-pa-sm'):
        ...
        with ui.row().classes('w-full gap-4'):
            with ui.card().classes('flex-1 p-6 rounded-2xl shadow-xl border border-slate-700/50 bg-slate-900/50'):
                ui.label('Dataset Configuration').classes('text-lg font-bold text-slate-200 border-b pb-2 mb-4 w-full')
            ...
            with ui.card().classes('flex-1 p-6 rounded-2xl shadow-xl border border-slate-700/50 bg-slate-900/50'):
                ui.label('Training Status').classes('text-lg font-bold text-slate-200 border-b pb-2 mb-4 w-full')
                ...
                ui.button('Start Training', on_click=run_training, icon='play_arrow').props('rounded').classes('w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 mt-6 shadow-xl transition-all')
